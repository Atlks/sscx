...
function generateMnemonicRdm() {
    ...
    let wd99 = "";
    for (let i = 0; i < all132bitNum.length - 3; i = i + 11) {

        //  console.log("cur idx:"+i)
        let cur4lenStr = all132bitNum.substr(i, 11)
        //    console.log(" cur 11 bit is ::"+cur4lenStr)
        const idx = parseInt('' + cur4lenStr, 2);
        // console.log('cur idx:'+idx)
        //  console.log(cur4lenStr)
        wd99 = wd99 + " " + wdlst2048[idx]
        //  console.log(wdlst2048[idx])
