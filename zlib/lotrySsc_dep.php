...
$content454 = "a12押9";
$content454 = "a123456押9";$content454 = "a123押100";
...
//C:\phpstudy_pro\Extensions\php\php8.0.2nts\php.exe app/common/lotrySsc.php
// 获取玩法
function getWefa($bet_nums)
{
    ...
    $numb = $bet_nums;
    // echo "betnum:" . $numb;   ,特码球玩法=\d\/\d\/\d+ 特码球大小单双玩法=\d\/[大小单双]\/\d+
    ...
    $wefa_rex = $wefa_rex . ",特码球玩法组合模式=[abcde][0123456789大小单双]+押\d+";
...
function isBanShunzi($num)
{
    ...
    $cye2 = substr($num, 0, 2);
    $ho2 = substr($num, 1, 2);
    $jo2 = lotrySsc_dep . phpsubstr($num, 0, 1) . substr($num, 2, 1);
    var_dumpx120($jo2);
    //   789  290>029  801>018
